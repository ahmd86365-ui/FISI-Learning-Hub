...
export const glossaryEntries: GlossaryEntry[] = [
  ...
  { id: 'bash', term: 'Bash', category: 'Linux', definition: 'Eine Shell, die eingegebene Befehle liest und ausführt.', lessons: [linux(), linux('terminal-und-erste-befehle')] },
  { id: 'terminal', term: 'Terminal', category: 'Linux', definition: 'Das Textfenster, das Eingaben annimmt und Ausgaben anzeigt. Die Befehle verarbeitet die darin laufende Shell.', lessons: [linux('terminal-und-erste-befehle')] },
  { id: 'shell', term: 'Shell', category: 'Linux', definition: 'Ein Programm wie Bash, das Befehle interpretiert und ihre Ergebnisse an das Terminal zurückgibt.', lessons: [linux('terminal-und-erste-befehle')] },
  { id: 'prompt', term: 'Prompt', category: 'Linux', definition: 'Die Eingabeaufforderung der Shell. Sie kann Benutzername, Rechnername und Arbeitsverzeichnis anzeigen.', lessons: [linux('terminal-und-erste-befehle')], aliases: ['Eingabeaufforderung'] },
  { id: 'dateipfad', term: 'Dateipfad', category: 'Linux', definition: 'Die Adresse einer Datei oder eines Ordners. Ein absoluter Pfad beginnt bei /; ein relativer beim aktuellen Verzeichnis.', lessons: [linux('terminal-und-erste-befehle')], aliases: ['Pfad', 'absoluter Pfad', 'relativer Pfad'] },
  { id: 'fhs', term: 'FHS', category: 'Linux', definition: 'Der Filesystem Hierarchy Standard beschreibt den üblichen Linux-Verzeichnisbaum und die vorgesehenen Inhalte seiner Verzeichnisse.', lessons: [linux('das-dateisystem')], aliases: ['Filesystem Hierarchy Standard'] },
  { id: 'root-verzeichnis', term: 'Root-Verzeichnis', category: 'Linux', definition: 'Die Wurzel / des einen Linux-Verzeichnisbaums. Sie ist nicht mit dem Home-Verzeichnis /root des Administrators zu verwechseln.', lessons: [linux('das-dateisystem')], aliases: ['Wurzelverzeichnis'] },
  { id: 'symbolischer-link', term: 'Symbolischer Link', category: 'Linux', definition: 'Ein Verweis auf eine andere Datei oder ein Verzeichnis. Ist das Ziel nicht mehr vorhanden, bleibt ein toter Link zurück.', lessons: [linux('das-dateisystem')], aliases: ['Symlink', 'Link'] },
  { id: 'uid-gid', term: 'UID und GID', category: 'Linux', definition: 'Numerische Kennungen für Benutzer und Gruppen. In /etc/passwd stehen sie im dritten und vierten Feld.', lessons: [linux('das-dateisystem')], aliases: ['UID', 'GID'] },
  { id: 'nano', term: 'nano', category: 'Linux', definition: 'Ein einfacher Terminal-Texteditor. Im Kurs wird mit Strg+O gespeichert, der Dateiname mit Enter bestätigt und mit Strg+X beendet.', lessons: [linux('das-dateisystem')] },
